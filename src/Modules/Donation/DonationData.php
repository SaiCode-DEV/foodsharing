...
class DonationData
{
    ...
    #[OA\Property(description: 'Donation Banner ID', example: 12345)]
    public int $donationBannerId = 0;

    #[OA\Property(description: 'One-Time Donation ID', example: 12345)]
    public int $oneTimeDonationId = 0;

    #[OA\Property(description: 'Show Campaign Banner', example: true)]
    ...
    #[OA\Property(description: 'Show Donation Modal in Hours', example: 24)]
    public int $showDonationModalInHours = 0;

    #[OA\Property(description: 'Iframe Friendship Circle URL', example: 'freundeskreis/abcdefg123')]
