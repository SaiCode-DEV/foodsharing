...
class VotingScope
{
     ...
     */
    final public const int FOODSAVERS = 0;
    /**
     * All users from {@link Role::FOODSAVER} upwards, only with verification.
     */
    final public const int VERIFIED_FOODSAVERS = 1;
    /**
     ...
     */
    final public const int STORE_MANAGERS = 2;
    /**
     * All ambassadors of the poll's region.
     */
    final public const int AMBASSADORS = 3;

    final public const int VERIFIED_FOODSAVERS_HOME_DISTRICT = 4;
