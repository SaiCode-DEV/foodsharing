...
{
    final public const ENABLE_REPORT_BUTTON = 1;
    final public const ENABLE_MEDIATION_BUTTON = 2;
    final public const REGION_PICKUP_RULE_ACTIVE = 3; // Is the PickUpRule for this region active ?
    final public const REGION_PICKUP_RULE_TIMESPAN_DAYS = 4; // What is the timespan for the pickuprule
