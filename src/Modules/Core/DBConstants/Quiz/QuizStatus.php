...
class QuizStatus
{
     ...
     * @var int
     */
    final public const NEVER_TRIED = 0;
     ...
     * @var int
     */
    final public const PAUSE_ELAPSED = 5;
     ...
     * @var int
     */
    final public const DISQUALIFIED = 6;
}
