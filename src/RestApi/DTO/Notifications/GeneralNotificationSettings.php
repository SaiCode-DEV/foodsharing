...
class GeneralNotificationSettings
{
    ...
    #[OA\Property(description: 'Whether the user recieves the newsletter via email. Can be sent as null to keep the current value.')]
    public ?bool $emailOnNewsletter = null;
