...
function generateTableMarkdownHeadingId(tablename) {
    return "table-" + tablename.toLowerCase().replace(/_/g, "-");
}
...
console.log("Schema JSON file " + schemaFile)
console.log("DB Meta data file " + dbMetaDataFile)
console.log("DB PHP Usage file " + dbUsageFile)

// Read schema from JSON file (generated by extract_schema_from_db.js)
const database_schema = JSON.parse(fs.readFileSync(schemaFile, { encoding: 'utf8', flag: 'r' }));
