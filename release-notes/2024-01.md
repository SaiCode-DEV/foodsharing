...
Wir haben (wie immer) versucht, an allen Ecken und Enden der Webseite Bestehendes zu verbessern und neue Funktionen umzusetzen. Hoffentlich können wir uns alle damit die Arbeit erleichtern und dazu beitragen, dass wir uns noch effektiver gegen die Lebensmittelverschwendung einsetzen!
...
- Die Glocken, die bei neuen Forenbeiträgen versendet werden, wurden verbessert: ( !2827, !2826)
    ...
    - Ein größerer Teil des Forum-Titels wird angezeigt. 
- Moderator:innen können jetzt auch in geschlossenen Foren-Threads schreiben, statt diese vorher öffnen und hinterher wieder schließen zu müssen. ( !3019)
- Beiträge können nun auch in geschlossenen Foren-Threads gelöscht werden. Berechtigt sind dazu nach wie vor die Autor:innen und [Orga-Nutzer](https://wiki.foodsharing.de/Benutzerrolle_:_Orga). ( !3019)
- Auch in geschlossenen Foren-Threads kann jetzt auf Nachrichten mit Smileys reagiert werden. ( !3019)
- Nutzt man den Antworten-Button unter Beiträgen, wird der usrprüngliche Beitrag in der eigenen Nachricht zitiert. ( !2937)
...
- Betriebsverantwortliche bekommen angezeigt, wie weit Bewerber:innen vom Betrieb entfernt wohnen, sodass leichter bevorzugt Foodsaver:innen aus der Nähe in Betriebsteams aufgenommen werden können. ( !2772)
...
- Unbestätigt gebliebene Eintragungen in Slots des vergangenen Tages werden nun nicht mehr automatisch um Mitternacht gelöscht, sondern bleiben erhalten. ( !2901)
...
- Alle Ergebnistypen enthalten mehr Informationen und Möglichkeiten, direkt zu den gesuchten Inhalten zu navigieren:
    ...
    - **Personen**: ID, Stammbezirk und ob die Person unverifiziert ist, werden angezeigt. Außerdem kannst du direkt einen Chat mit der gesuchten Person öffnen und diese aus dem Suchfenster heraus anrufen, falls ihr in einem gemeinsamen Betriebsteam seid.
