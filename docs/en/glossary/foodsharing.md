...
English term | German term | abbreviation | description
 --- |---| ---|---
pick-up / slot | Abholung / Slot | | Appointment at which foodsavers will pick up food at a store or perform another action coordinated via slots.
...
store chain | Betriebskette | | Business structure with more than 3 companies. Chains and relevant branches are only addressed in consultation with the respective Key Account Manager or the company chain group.
...
food share point | Fairteiler | FT | Place where all people (even without registration on foodsharing.de) can bring food for free and pick up.
...
rule violation | Regelverletzung | | Rule violation messages are an important tool to address problems, inconsistencies and misunderstandings before they escalate into bigger conflicts. It is always preferred to first resolve things personally if it is possible.
